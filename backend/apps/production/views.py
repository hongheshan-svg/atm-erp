...
class ProductionPlanProcessViewSet(PermissionMixin, SoftDeleteMixin, UserTrackingMixin, viewsets.ModelViewSet):
    permission_module = 'production'
    permission_resource = 'plan_process'
    """
    生产计划工序管理 ViewSet
    """
...
class DebugCheckItemViewSet(PermissionMixin, SoftDeleteMixin, UserTrackingMixin, viewsets.ModelViewSet):
    permission_module = 'production'
    permission_resource = 'debug_check_item'
    """
    调试检查项管理 ViewSet
    """
