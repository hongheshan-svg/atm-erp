...
class ExecutiveDashboardView(APIView):
    ...
    def _get_finance_overview(self, month_start):
        """财务概览"""
        from apps.finance.collection_models import CollectionPlan, CollectionMilestone
...
class ProductionDashboardView(APIView):
    ...
    def get(self, request):
        ...
        from apps.production.models import (
            ProductionPlan, ProductionPlanProcess,
            DebugRecord, QualityInspection
        )
...
class FinanceDashboardView(APIView):
    ...
    def get(self, request):
        ...
        from apps.finance.collection_models import CollectionPlan, CollectionMilestone, CollectionRecord
