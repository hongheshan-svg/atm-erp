...
def build_permission_tree():
    ...
    tree.append(menu('projects:timelog', '工时记录', 5, route_path='/projects/timelogs', parent_code='projects'))
    tree.append(menu('projects:milestone', '里程碑', 6, route_path='/projects/milestones', parent_code='projects'))
    tree.append(menu('projects:installation', '安装调试', 7, route_path='/projects/installation', parent_code='projects'))
    tree.append(menu('projects:acceptance', '验收管理', 8, route_path='/projects/acceptance', parent_code='projects'))
    ...
    tree.append(menu('sales:delivery', '发货管理', 6, route_path='/sales/deliveries', parent_code='sales'))
    ...
    tree.append(menu('supply:receipt', '到货验收', 3, route_path='/purchase/receipts', parent_code='supply'))
    ...
    tree.append(menu('manufacturing:routing', '工艺路线', 2, route_path='/production/routing', parent_code='manufacturing'))
    tree.append(menu('manufacturing:aps', 'APS排程', 3, route_path='/mes/aps', parent_code='manufacturing'))
    ...
    tree.append(menu('finance:receivable', '应收管理', 1, route_path='/finance/receivables', parent_code='finance'))
    tree.append(menu('finance:payable', '应付管理', 2, route_path='/finance/payables', parent_code='finance'))
    ...
    tree.append(menu('oa:meeting', '会议日程', 3, route_path='/oa/meetings', parent_code='oa'))
    tree.append(menu('oa:announcement', '公告通知', 4, route_path='/oa/announcements', parent_code='oa'))
