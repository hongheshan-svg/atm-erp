...
class WorkflowDefinitionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'code', 'business_type', 'business_type_display',
            'description', 'is_active', 'amount_threshold',
...
class WorkflowTaskSerializer(serializers.ModelSerializer):
    ...
    business_type_display = serializers.CharField(
        source='instance.workflow.get_business_type_display', read_only=True
    )
    ...
    class Meta:
        model = WorkflowTask
        fields = [
            'id', 'instance', 'step', 'step_name', 'step_order',
            'assignee', 'assignee_name', 'status', 'status_display',
            'action_time', 'comment', 'deadline',
            'business_no', 'business_type', 'business_type_display',
            'workflow_name', 'submitter_name', 'amount',
...
class WorkflowInstanceSerializer(serializers.ModelSerializer):
    ...
    business_type_display = serializers.CharField(
        source='workflow.get_business_type_display', read_only=True
    )
    ...
    class Meta:
        ...
        fields = [
            ...
            'business_type', 'business_type_display', 'business_id', 'business_no',
            'submitter', 'submitter_name', 'submit_time',
