...
urlpatterns = [
    ...
    # 工作流可视化API
    path('visualization/', WorkflowOverviewView.as_view(), name='workflow-overview'),
    path('visualization/<int:workflow_id>/', WorkflowDetailView.as_view(), name='workflow-visualization'),
