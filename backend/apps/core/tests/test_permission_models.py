...
class PermissionModelTest(TestCase):
    ...
    def test_create_menu_permission(self):
        ...
        menu = Permission.objects.create(
            code='system', name='系统管理', type='menu', route_path='/system', icon='el-icon-setting', sort_order=1
        )
    ...
    def test_create_child_permission(self):
        ...
        parent = Permission.objects.create(code='system', name='系统管理', type='menu', sort_order=1)
        child = Permission.objects.create(
            parent=parent, code='system:user', name='用户管理', type='menu', route_path='/system/user', sort_order=1
        )
    ...
    def test_create_operation_permission(self):
        ...
        menu = Permission.objects.create(code='system:user', name='用户管理', type='menu', sort_order=1)
        operation = Permission.objects.create(
            parent=menu, code='system:user:create', name='创建用户', type='operation', resource='user', sort_order=1
        )
    ...
    def test_create_field_permission(self):
        ...
        operation = Permission.objects.create(
            code='system:user:view', name='查看用户', type='operation', resource='user', sort_order=1
        )
    ...
    def test_permission_code_unique(self):
        ...
        Permission.objects.create(code='system', name='系统管理', type='menu', sort_order=1)
        with self.assertRaises(IntegrityError):
            Permission.objects.create(code='system', name='系统管理2', type='menu', sort_order=2)

    def test_permission_str(self):
        """Test string representation of permission"""
        permission = Permission.objects.create(code='system', name='系统管理', type='menu', sort_order=1)
    ...
    def test_is_active_filtering(self):
        ...
        active = Permission.objects.create(
            code='system:active', name='Active Permission', type='menu', is_active=True, sort_order=1
        )
        # Create inactive permission
        inactive = Permission.objects.create(
            code='system:inactive', name='Inactive Permission', type='menu', is_active=False, sort_order=2
        )
    ...
    def test_validation_field_permission_without_field_name(self):
        ...
        field_perm = Permission(
            code='system:user:view:field', name='Field Permission', type='field', resource='user', sort_order=1
        )
    ...
    def test_validation_operation_permission_without_resource(self):
        ...
        operation_perm = Permission(code='system:user:create', name='Create User', type='operation', sort_order=1)
        with self.assertRaises(ValidationError) as context:
    ...
    def test_validation_self_referencing_parent(self):
        ...
        permission = Permission.objects.create(code='system', name='System', type='menu', sort_order=1)
    ...
    def test_children_relationship_queries(self):
        ...
        parent = Permission.objects.create(code='system', name='System Management', type='menu', sort_order=1)
        child1 = Permission.objects.create(
            parent=parent, code='system:user', name='User Management', type='menu', sort_order=1
        )
        child2 = Permission.objects.create(
            parent=parent, code='system:role', name='Role Management', type='menu', sort_order=2
        )
...
class RolePermissionModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.permission = Permission.objects.create(
            code='system:user:create', name='创建用户', type='operation', resource='user', sort_order=1
        )
...
class DataScopeModelTest(TestCase):
    ...
    def setUp(self):
        """Set up test data"""
        self.role = Role.objects.create(name='测试角色', code='test_role')
        self.dept1 = Department.objects.create(name='研发部', code='RD')
        self.dept2 = Department.objects.create(name='销售部', code='SALES')

    def test_create_global_scope(self):
        """Test creating a global data scope"""
        scope = DataScope.objects.create(role=self.role, module='projects', scope_type='all')
    ...
    def test_create_module_scope(self):
        ...
        scope = DataScope.objects.create(role=self.role, module='sales', scope_type='dept')
    ...
    def test_create_custom_scope_with_departments(self):
        ...
        scope = DataScope.objects.create(role=self.role, module='purchase', scope_type='custom')
    ...
    def test_data_scope_unique_per_role_module(self):
        ...
        DataScope.objects.create(role=self.role, module='projects', scope_type='all')
        with self.assertRaises(IntegrityError):
            DataScope.objects.create(role=self.role, module='projects', scope_type='dept')

    def test_scope_type_choices(self):
        """Test that scope_type must be one of the valid choices"""
        scope = DataScope.objects.create(role=self.role, module='inventory', scope_type='self')
