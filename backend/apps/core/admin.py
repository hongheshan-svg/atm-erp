...
from .models import AuditLog, Attachment, SystemNotification
...
class AttachmentAdmin(admin.ModelAdmin):
    list_display = ['original_name', 'related_model', 'related_id', 'category', 
...
class LoginLogAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ['user', 'username', 'ip_address', 'user_agent', 'status',
...
class SensitiveOperationLogAdmin(admin.ModelAdmin):
    list_display = ['created_at', 'user', 'operation_type', 'target_model', 
                    'target_desc', 'confirmed']
    list_filter = ['operation_type', 'confirmed', 'created_at']
    search_fields = ['target_desc', 'user__username']
    readonly_fields = ['user', 'operation_type', 'target_model', 'target_id',
                       'target_desc', 'ip_address', 'created_at']
...
class WebhookDeliveryAdmin(admin.ModelAdmin):
    list_display = ['endpoint', 'event_type', 'status', 'attempts', 
                    'response_status', 'created_at', 'delivered_at']
    list_filter = ['status', 'event_type', 'created_at']
    search_fields = ['endpoint__name', 'event_type']
    readonly_fields = ['endpoint', 'event_type', 'payload', 'status', 
...
class DashboardWidgetAdmin(admin.ModelAdmin):
    list_display = ['name', 'code', 'widget_type', 'data_source', 
