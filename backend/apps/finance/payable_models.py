...
class PayableSettlement(BaseModel):
    ...
    bank_statement = models.ForeignKey(
        'finance.BankStatement', on_delete=models.PROTECT, related_name='payable_settlements', verbose_name='银行流水'
    )
    payable_item = models.ForeignKey(
        PayableItem, on_delete=models.PROTECT, related_name='settlements', verbose_name='待付款项'
    )
