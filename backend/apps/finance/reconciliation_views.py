...
from .reconciliation_serializers import (
    PurchaseReconciliationSerializer, PurchaseReconciliationListSerializer,
    PurchaseReconciliationLineSerializer,
    SalesReconciliationSerializer, SalesReconciliationListSerializer,
    SalesReconciliationLineSerializer,
    InvoiceReconciliationSerializer, InvoiceReconciliationListSerializer,
    InvoiceReconciliationLineSerializer
)
...
class SalesReconciliationViewSet(SoftDeleteMixin, UserTrackingMixin, DataPermissionMixin, viewsets.ModelViewSet):
    ...
    def generate_lines(self, request, pk=None):
        ...
        from apps.sales.models import SalesOrder, DeliveryOrder
