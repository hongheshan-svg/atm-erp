...
class PurchaseReconciliation(BaseModel):
    ...
    supplier = models.ForeignKey(
        Supplier, on_delete=models.PROTECT, related_name='purchase_reconciliations', verbose_name='供应商'
    )
    ...
    # 汇总金额
    total_order_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='订单总金额')
    total_received_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='已收货金额')
    total_invoice_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='发票金额')
    total_paid_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='已付款金额')
    balance_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='差额/欠款')

    # 期初余额
    opening_balance = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='期初余额')
    # 期末余额
    closing_balance = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='期末余额')
...
class PurchaseReconciliationLine(BaseModel):
    ...
    reconciliation = models.ForeignKey(
        PurchaseReconciliation, on_delete=models.CASCADE, related_name='lines', verbose_name='对账单'
    )
    ...
    # 金额
    debit_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='借方金额')
    credit_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='贷方金额')
    balance = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='余额')

    # 收货状态相关
    order_qty = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='订单数量')
    ...
    receipt_status = models.CharField(
        max_length=20, choices=RECEIPT_STATUS_CHOICES, default='NOT_RECEIVED', verbose_name='收货状态'
    )
    ...
    # 付款进度相关
    payable_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='应付金额')
    paid_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='已付金额')
    payment_progress = models.DecimalField(max_digits=5, decimal_places=2, default=0, verbose_name='付款进度(%)')
...
class SalesReconciliation(BaseModel):
    ...
    customer = models.ForeignKey(
        Customer, on_delete=models.PROTECT, related_name='sales_reconciliations', verbose_name='客户'
    )
    ...
    # 汇总金额
    total_order_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='订单总金额')
    total_delivered_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='已发货金额')
    total_invoice_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='发票金额')
    total_received_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='已收款金额')
    balance_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='差额/应收')
...
class SalesReconciliationLine(BaseModel):
    ...
    reconciliation = models.ForeignKey(
        SalesReconciliation, on_delete=models.CASCADE, related_name='lines', verbose_name='对账单'
    )
    line_type = models.CharField(max_length=20, choices=LINE_TYPE_CHOICES, verbose_name='类型')
    ...
    # 发货状态相关
    order_qty = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='订单数量')
    delivered_qty = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='已发货数量')
    delivery_status = models.CharField(
        max_length=20, choices=DELIVERY_STATUS_CHOICES, default='NOT_DELIVERED', verbose_name='发货状态'
    )
    ...
    # 收款进度相关
    receivable_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='应收金额')
    received_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='已收金额')
    collection_progress = models.DecimalField(max_digits=5, decimal_places=2, default=0, verbose_name='收款进度(%)')
...
class InvoiceReconciliation(BaseModel):
    ...
    total_invoice_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='发票总金额')
    total_tax_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='税额合计')
    matched_count = models.IntegerField(default=0, verbose_name='已匹配数量')
    matched_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='已匹配金额')
    unmatched_count = models.IntegerField(default=0, verbose_name='未匹配数量')
    unmatched_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='未匹配金额')
...
class InvoiceReconciliationLine(BaseModel):
    ...
    reconciliation = models.ForeignKey(
        InvoiceReconciliation, on_delete=models.CASCADE, related_name='lines', verbose_name='对账单'
    )
    ...
    amount_before_tax = models.DecimalField(max_digits=15, decimal_places=2, verbose_name='不含税金额')
    ...
    matched_order_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='订单金额')
    difference_amount = models.DecimalField(max_digits=15, decimal_places=2, default=0, verbose_name='差异金额')

    match_status = models.CharField(
        max_length=20, choices=MATCH_STATUS_CHOICES, default='UNMATCHED', verbose_name='匹配状态'
    )
    notes = models.TextField(blank=True, verbose_name='备注')
