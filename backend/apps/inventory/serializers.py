...
class StockSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['qty_on_hand', 'weighted_avg_cost', 'updated_at']

    def get_qty_available(self, obj) -> float:
...
class StockMoveSerializer(serializers.ModelSerializer):
    ...
    def get_reference_no(self, obj) -> str:
...
class StockAdjustmentSerializer(serializers.ModelSerializer):
    ...
    def get_cost_impact(self, obj) -> float:
