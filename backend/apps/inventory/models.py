...
class Stock(BaseModel):
    ...
    warehouse = models.ForeignKey(
        'masterdata.Warehouse', on_delete=models.PROTECT, related_name='stocks', verbose_name='仓库'
    )
    item = models.ForeignKey('masterdata.Item', on_delete=models.PROTECT, related_name='stocks', verbose_name='物料')
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['warehouse', 'item'], condition=models.Q(is_deleted=False), name='stock_unique_active'
            ),
            models.CheckConstraint(condition=models.Q(qty_on_hand__gte=0), name='stock_qty_non_negative'),
        ]
