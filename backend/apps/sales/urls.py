...
from .after_sales_service import (
    ...
    CustomerPortalSubmitRequestView,
...
from .funnel_analysis import OpportunityStageAnalysisView, SalesFunnelView, SalespersonRankingView, SalesTrendView
from .performance import (
    CustomerRFMAnalyzeView,
    CustomerRFMSegmentSummaryView,
    CustomerRFMTopCustomersView,
...
from .quote_estimation import (
    CostCategoryViewSet,
    EstimationLaborItemViewSet,
    EstimationMaterialItemViewSet,
    EstimationOutsourceItemViewSet,
    LaborRateViewSet,
    ProjectCostHistoryViewSet,
    QuoteEstimationViewSet,
)
from .quote_prediction import (
    QuoteComparisonViewSet,
    QuoteCostItemViewSet,
...
from .views import (
    ...
    SalesOrderViewSet,
    SalesQuotationLineViewSet,
    SalesQuotationViewSet,
)
from .win_loss_analysis import (
    OpportunityCloseRecordViewSet,
    WinLossAnalysisView,
    WinLossComparisonView,
    WinLossReasonViewSet,
)
