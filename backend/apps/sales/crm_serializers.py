...
class LeadListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Lead
        fields = [
            'id', 'lead_no', 'company_name', 'contact_name', 'contact_phone',
            'industry', 'source', 'source_name', 'status', 'status_display',
            'owner', 'owner_name', 'score', 'created_at'
        ]
...
class OpportunityListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Opportunity
        fields = [
            'id', 'opportunity_no', 'name', 'customer', 'customer_name',
            'stage', 'stage_display', 'priority', 'priority_display',
            'probability', 'estimated_amount', 'weighted_amount',
            'expected_close_date', 'owner', 'owner_name', 'created_at'
        ]
