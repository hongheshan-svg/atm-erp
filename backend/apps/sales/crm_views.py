...
from .crm_serializers import (
    LeadSourceSerializer, LeadSerializer, LeadListSerializer,
    OpportunitySerializer, OpportunityListSerializer,
    OpportunityActivitySerializer, SalesForecastSerializer,
    LeadConvertSerializer, OpportunityStageChangeSerializer,
