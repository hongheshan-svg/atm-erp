...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='so',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='contracts', to='sales.salesorder', verbose_name='销售订单'),
        ),
        migrations.AlterField(
            model_name='salescontract',
            name='status',
        ...
        migrations.AlterField(
            ...
            name='status',
            field=models.CharField(choices=[('DRAFT', '草稿'), ('PENDING', '审批中'), ('APPROVED', '已审批'), ('SENT', '已发送'), ('ACCEPTED', '已接受'), ('REJECTED', '已拒绝'), ('EXPIRED', '已过期')], default='DRAFT', max_length=20, verbose_name='状态'),
        ),
