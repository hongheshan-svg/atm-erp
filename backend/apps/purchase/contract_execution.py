...
class ContractExecutionViewSet(
    ...
    def submit(self, request, pk=None):
        ...
        result = self.start_workflow_or_auto_approve(
            execution, request.user, approved_status='IN_PROGRESS', submitted_status='NOT_STARTED'
        )
...
class PaymentRecordViewSet(
    ...
    def submit(self, request, pk=None):
        ...
        result = self.start_workflow_or_auto_approve(
            payment, request.user, approved_status='APPROVED', submitted_status='PENDING'
        )
        if result['auto_approved']:
