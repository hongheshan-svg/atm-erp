...
class ProjectProfitabilityReportView(APIView):
    ...
    def get(self, request):
        ...
        from apps.projects.cost_tracking import ProjectCostRecord, ProjectBudget
...
class OutsourceAnalysisReportView(APIView):
    ...
    def get(self, request):
        from apps.purchase.outsource_tracking import (
            OutsourceOrder, OutsourceInspection, OutsourceCapability
        )
