...
urlpatterns = [
    ...
    # 非标自动化行业专用报表
    path(
        'industry/project-profitability/', ProjectProfitabilityReportView.as_view(), name='project-profitability-report'
    ),
    ...
    path(
        'project-profitability/export/', ProjectProfitabilityExportView.as_view(), name='project-profitability-export'
    ),
]
