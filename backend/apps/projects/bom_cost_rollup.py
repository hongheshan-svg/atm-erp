...
class BOMCostSnapshot(BaseModel):
    project = models.ForeignKey(
        ...
        related_name='bom_cost_snapshots', verbose_name='项目'
    )
    ...
    grand_total = models.DecimalField(
        max_digits=14, decimal_places=2, default=Decimal('0.00'), verbose_name='总计'
    )
    calculated_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL,
        null=True, blank=True, related_name='bom_cost_calculations', verbose_name='计算人'
    )
...
class BOMCostDetail(BaseModel):
    snapshot = models.ForeignKey(
        BOMCostSnapshot, on_delete=models.CASCADE,
        related_name='details', verbose_name='成本快照'
    )
    ...
    parent_material_code = models.CharField(
        max_length=100, blank=True, default='', verbose_name='父物料编码'
    )
    quantity = models.DecimalField(
        max_digits=12, decimal_places=4, default=Decimal('0.0000'), verbose_name='数量'
    )
    ...
    labor_cost = models.DecimalField(
        max_digits=12, decimal_places=2, default=Decimal('0.00'), verbose_name='人工成本'
    )
    ...
    subtotal = models.DecimalField(
        max_digits=14, decimal_places=2, default=Decimal('0.00'), verbose_name='小计'
    )
