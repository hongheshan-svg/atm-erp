...
// 两项逾期金额已经在待收款、待付款主卡的说明里，这里不再重复一遍。
const watchAmounts: { key: string; label: string }[] = [
