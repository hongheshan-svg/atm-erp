...
const { selectedRows, handleSelectionChange, batchDelete, batchExport } = useBatchOperation('/api/core/dict-items/', { onSuccess: () => selectedType.value && selectType(selectedType.value) })
