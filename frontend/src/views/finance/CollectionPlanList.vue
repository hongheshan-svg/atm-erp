<template>
  <div class="collection-container">
    ...
    <el-card>
      ...
      <el-table :data="plans" v-loading="loading" stripe style="width: 100%; margin-top: 16px" @selection-change="handleSelectionChange">
...
const { selectedRows, handleSelectionChange, batchDelete, batchExport } = useBatchOperation('/api/finance/collection-plans/', { onSuccess: () => fetchData() })
