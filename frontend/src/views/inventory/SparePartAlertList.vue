...
const { selectedRows, handleSelectionChange, batchDelete, batchExport } = useBatchOperation('/api/inventory/spare-part-alerts/', { onSuccess: () => loadData() })
...
const getAlertType = (t: any) => (({ 'LOW_STOCK': 'warning', 'OUT_OF_STOCK': 'danger', 'EXPIRING': 'info' } as Record<string, any>)[t] || 'info')
