...
export function getTechDocumentList(params) {
  return request({ url: '/projects/tech-documents/', method: 'get', params })
}

export function getTechDocument(id) {
  return request({ url: `/projects/tech-documents/${id}/`, method: 'get' })
}

export function createTechDocument(data, config) {
