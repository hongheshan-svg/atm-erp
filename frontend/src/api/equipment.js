...
export function shipEquipment(id, data) {
  return request({ url: `/projects/equipment/${id}/ship/`, method: 'post', data })
}

// ========== 检验管理 ==========
export function getInspectionTemplateList(params) {
...
export function createInspectionFromTemplate(data) {
...
export function completeMaintenanceSchedule(id, data) {
...
export function getMaintenanceCalendar(params) {
...
export function checkoutFixture(id, data) {
  return request({ url: `/projects/fixtures/${id}/checkout/`, method: 'post', data })
}
export function returnFixture(id, data) {
...
export function getCalibrationDueFixtures(params) {
...
// ========== OEE分析 ==========
export function getOEERecordList(params) {
  return request({ url: '/projects/oee-records/', method: 'get', params })
}
export function getOEEByEquipment(params) {
...
// ========== 工装操作 ==========
export function calibrateFixture(id, data) {
  return request({ url: `/projects/fixtures/${id}/calibrate/`, method: 'post', data })
}
export function maintainFixture(id, data) {
...
export function completeInspectionRecord(id, data) {
  return request({ url: `/projects/inspection-records/${id}/complete/`, method: 'post', data })
}
export function copyInspectionTemplate(id, data) {
