...
export function getVehicleMaintenanceRecords(id) {
...
// ========== 用车申请 ==========
export function getVehicleRequests(params) {
  return request({ url: '/oa/vehicle-requests/', method: 'get', params })
}
export function createVehicleRequest(data) {
  return request({ url: '/oa/vehicle-requests/', method: 'post', data })
}
export function updateVehicleRequest(id, data) {
...
// ========== 档案管理 ==========
export function getArchiveCategories(params) {
...
// ========== 档案借阅 ==========
export function getArchiveBorrows(params) {
  return request({ url: '/oa/archive-borrows/', method: 'get', params })
}
export function createArchiveBorrow(data) {
...
export function reclaimAsset(id) {
...
export function submitAssetBorrow(id) {
...
export function syncAttendanceDevice(id) {
...
export function getIMMessages(params) {
...
export function uploadIMFile(data, config) {
  return request({ url: '/core/messages/', method: 'post', data, ...config })
}

// ========== 会议管理 (core) ==========
export function getCoreMeetings(params) {
  return request({ url: '/core/meetings/', method: 'get', params })
}
export function getCoreMeeting(id) {
...
export function completeMeeting(id, data) {
...
export function updateCoreMeeting(id, data) {
  return request({ url: `/core/meetings/${id}/`, method: 'patch', data })
}
export function createCoreMeeting(data) {
  return request({ url: '/core/meetings/', method: 'post', data })
}

// ========== 日程管理 (core) ==========
export function getCalendarSchedules(params) {
...
export function getCoreSchedule(id) {
  return request({ url: `/core/schedules/${id}/`, method: 'get' })
}
export function updateCoreSchedule(id, data) {
  return request({ url: `/core/schedules/${id}/`, method: 'patch', data })
}
export function createCoreSchedule(data) {
