 ...
 * 生成销售报价单打印内容
 */
export function generateQuotationPrintContent(quotation) {
  ...
  return `
    ...
    <div class="print-info">
      <div>
        <span class="print-info-item"><span class="print-info-label">客户：</span>${quotation.customer_name || ''}</span>
      </div>
      <div>
    ...
    <div style="margin-bottom: 15px;">
      <p><strong>备注：</strong>${quotation.notes || '无'}</p>
    </div>
 ...
 * 生成发货单打印内容
 */
export function generateDeliveryOrderPrintContent(delivery) {
  ...
  return `
    ...
    <div class="print-info">
      ...
      <div>
        <span class="print-info-item"><span class="print-info-label">发货日期：</span>${delivery.delivery_date || ''}</span>
      </div>
    </div>
    ...
    <div class="print-info">
      <div>
        <span class="print-info-item"><span class="print-info-label">发货仓库：</span>${delivery.warehouse_name || ''}</span>
      </div>
    </div>
    ...
    <div style="margin-bottom: 15px;">
      <p><strong>备注：</strong>${delivery.notes || '无'}</p>
    </div>
